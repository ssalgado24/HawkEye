 ...
 * @author USUARIO
 */
public class CADeportiva extends javax.swing.JFrame {
    ...
    String coordinador = "";
    Deportiva nuevaActividadDeportiva;
    ...
    public CADeportiva() {
        ...
        ImageIcon imagenFondo3 = new ImageIcon(this.getClass().getResource("/imagenes/iconos/15.1.jpg"));
    ...
    private void initComponents() {
        ...
        jLabel10.setText("CREAR UNA ACTIVIDAD");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtNombreCoordinador))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(txtDeporte, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        descripcion = "Deportiva: " + this.txtDescripcion.getText();
        fechaHora = this.txtFechaHora.getText();
        deporte = this.txtDeporte.getText();
        ...
        if (nombre.length() > 0 || descripcion.length() > 0 || fechaHora.length() > 0
                || deporte.length() > 0 || recomendaciones.length() > 0 || coordinador.length() > 0) {
            nuevaActividadDeportiva = new Deportiva(nombre, descripcion, fechaHora,recomendaciones, deporte,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CADeportiva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CADeportiva().setVisible(true);
            }
        });
    }
